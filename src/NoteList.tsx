...
import { Badge, Button, Card, Col, Form, FormControl, FormLabel, Modal, Row, Stack } from "react-bootstrap";
            ...
            <Form>
                <Row className="mb-4">
                    ...
                    <Form.Group controlId="title">
                        ...
                        <FormControl type="text" value={title} onChange={e => setTitle(e.target.value)}></FormControl>
                    </Form.Group>
